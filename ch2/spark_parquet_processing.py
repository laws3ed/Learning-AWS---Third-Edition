...
print("Spark parquet processing start time: ", datetime.now())
...
df1 = spark.read.parquet("/work/data/parquet_partitioned_dir_1")
df1=df1.sort("event_time1")
df2 = spark.read.parquet("/work/data/parquet_partitioned_dir_2")
...
df_final.write.mode("overwrite").parquet("/work/data/spark_output_parquet")
end = time.time()

print("Total time: {:.3f}".format(end-start)," sec")
print("Spark parquet processing end time: ", datetime.now())
