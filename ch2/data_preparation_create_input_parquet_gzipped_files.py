...
#df2.set_index('event_time2', inplace=True)
df2=df2.sort_values(by=['event_time2'])

#convert to parquet format with 16 partitions
ddf1 = dd.from_pandas(df1, npartitions=16)
ddf1.to_parquet("/work/data/parquet_gzipped_dir_1/", write_index=False, engine='fastparquet', times='int96', overwrite=True, compression="gzip")
print("Listing the contents of the parquet file directory 1:")
print(os.listdir('/work/data/parquet_gzipped_dir_1'))

ddf2 = dd.from_pandas(df2, npartitions=8)
ddf2.to_parquet("/work/data/parquet_gzipped_dir_2/", write_index=False, engine='fastparquet', times='int96', overwrite=True, compression="gzip")
print("Listing the contents of the parquet file directory 2:")
print(os.listdir('/work/data/parquet_gzipped_dir_2'))
